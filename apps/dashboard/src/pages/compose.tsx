...
const initialNodes: Node[] = [
  ...
  },
  {
    ...
    data: {
      label: 'Write API Spec', definition: 'openapi:generate-spec', type: 'task', reasoning: 'medium', agent: 'Smith',
  ...
  },
  {
    ...
    data: {
      label: 'Implement Backend', definition: 'code:implement-backend', type: 'task', reasoning: 'high', agent: 'Smith',
  ...
  },
  {
    ...
    data: {
      label: 'Implement Frontend', definition: 'code:implement-frontend', type: 'task', reasoning: 'high', agent: 'Smith',
